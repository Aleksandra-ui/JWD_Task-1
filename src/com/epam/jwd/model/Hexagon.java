...
public class Hexagon extends Figure {
	...
	protected Hexagon(Point... points) {
	...
	public int calculateSquare() {
		return figurePropertiesStrategy.calculateSquare(p1, p2, p3, p4, p5, p6);
	}

	public int calculatePerimeter() {
		return figurePropertiesStrategy.calculatePerimeter(p1, p2, p3, p4, p5, p6);
	}
